package com.stx.xiaohaibin.aframelibrary.widget.keyboard;
...
public class SecurityKeyboard extends PopupWindow {
    ...
    public SecurityKeyboard(final ViewGroup parentLayout, SecurityConfigure securityConfigure) {
        ...
        if (SizeUtils.dp2px( 236) > (int) (ScreenUtils
                .getScreenHeight() * 3.0f / 5.0f)) {
    ...
    private void showKeyboard(View view) {
        ...
        yOff = realHeight - SizeUtils.dp2px(231);

        if (SizeUtils.dp2px(236) > (int) (ScreenUtils
                .getScreenHeight() * 3.0f / 5.0f)) {
            yOff = ScreenUtils.getScreenHeight()
                    - SizeUtils.dp2px( 199);
        }
